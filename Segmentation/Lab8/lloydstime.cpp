...
int main()
{
    ...
    pair<vector<Point>, vector<Point>> points_centroids = kmeans_clustering_with_epochs(points, 512, 2560, 20);
...
void createppm(vector<vector<int>> &picture)
{
    ...
    for(int i = 0; i < 800; i++)
    {
        for(int j = 0; j < 800; j++)
        {
            if(picture[i][j] == 1)//light green
            {
                ofs << 0 << " " << 255 << " " << 34 << " ";
            }
            else if(picture[i][j] == 2)//red
            {
                ofs << 255 << " " << 0 << " " << 0 << " ";
            }
            else if(picture[i][j] == 3)//yellow
            {
                ofs << 251 << " " << 255 << " " << 0 << " ";
            }
            else if(picture[i][j] == 4)//pink
            {
                ofs << 234 << " " << 0 << " " << 255 << " ";
            }
            else if(picture[i][j] == 5)//blue
            {
                ofs << 0 << " " << 221 << " " << 255 << " ";
            }
            else
